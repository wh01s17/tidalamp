...
> [!IMPORTANT]
> **PyPI está en marcha:** todas las versiones hasta `0.11.2` se publicaron mediante
> Trusted Publishing, sin ningún token de larga vida; la `0.12.0` está preparada y
