...
> [!IMPORTANT]
> **PyPI está en marcha:** todas las versiones hasta `0.11.0` se publicaron mediante
> Trusted Publishing, sin ningún token de larga vida; la `0.11.1` está preparada y
