...
> [!IMPORTANT]
> **PyPI está en marcha:** todas las versiones hasta `0.10.0` se publicaron mediante
> Trusted Publishing, sin ningún token de larga vida; la `0.11.0` está preparada y
