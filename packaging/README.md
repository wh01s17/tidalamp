...
> [!IMPORTANT]
> **PyPI está en marcha:** todas las versiones hasta `0.11.1` se publicaron mediante
> Trusted Publishing, sin ningún token de larga vida; la `0.11.2` está preparada y
> pendiente del tag, con el checksum en `SKIP` hasta que exista. El `PKGBUILD` del AUR
