...
def releases() -> tuple[Release, ...]:
    ...
    return (
        Release(
            ...
            "2026-09-26",
            (
                _("Una pista con varios artistas los nombra a todos."),
                _("El artista que no cabe en la cola se desliza para verse entero."),
                _("En pantalla completa, el álbum ya no se sale con muchos artistas."),
                _("Ratón: clic selecciona, doble clic reproduce, derecho abre el menú."),
            ),
        ),
        Release(
            "0.19.0",
        ...
        Release(
            ...
            "2026-09-19",
            (
                _("En pantalla completa, y pone la letra al lado de la carátula."),
                _("Con la cola abierta: carátula, letra y cola, de izquierda a derecha."),
                _("Iconos del transporte más gruesos y con aire entre signo y marca."),
            ),
        ),
        Release(
            "0.13.0",
    ...
    return (
        ...
        Section(
            ...
            (
                ...
                (key("credits"), _("créditos y licencia (solo «Lofi sin copyright»)")),
        ...
        Section(
            ...
            (
                ...
                (key("credits"), _("créditos y licencia de la pista")),
        ...
        Section(
            ...
            (
                ...
                ("k", _("créditos y licencia (solo «Lofi sin copyright»)")),
                ("esc", _("cerrar")),
            ),
            name="browser",
        ),
