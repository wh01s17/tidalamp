...
> [!IMPORTANT]
> **Estado a 2026-09-15:** hay trece versiones publicadas en PyPI, hasta `0.10.0`, con
> Trusted Publishing, cada una con su GitHub Release. La `0.11.0` está preparada y
> validada en local, pendiente del tag. El environment `pypi` de GitHub existe y el publisher de PyPI ya
