...
> [!IMPORTANT]
> **Estado a 2026-09-12:** hay once versiones publicadas en PyPI, hasta `0.8.1`, con
> Trusted Publishing; la `0.9.0` está preparada y sin etiquetar. El environment `pypi` de GitHub existe y el publisher de PyPI ya
